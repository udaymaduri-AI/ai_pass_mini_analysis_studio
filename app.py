...
def load_sample_data():
    ...
    try:
        ...
        df = pd.read_csv(os.path.join(base_dir, 'data', 'sample_energy_data.csv'))
    ...
    for insight in insights:
        if insight['type'] == 'trend':
            ...
            if 'energy' in col.lower() or 'consumption' in col.lower():
                ...
                elif direction == 'downward' and float(strength) > 5:
                    recommendations.append({
    ...
    with tab2:
        ...
        if len(numeric_cols) > 0:
            ...
            if selected_col:
                ...
                with col3:
                    st.metric("Anomalies Found", anomalies_iqr.sum())
                with col4:
        ...
        if date_col:
            ...
            try:
                ...
                if len(numeric_cols) > 0:
                    ...
                    # Monthly trend chart
                    fig = px.line(monthly_stats.reset_index(),
